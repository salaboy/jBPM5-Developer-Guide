...
import com.salaboy.jbpm5.dev.guide.workitems.InsuranceServiceWorkItemHandler;

public class SimpleWebServiceTaskTest {
    ...
    private void initializeWebService() {
		...
		this.endpoint = Endpoint.publish(
    			"http://127.0.0.1:9999/WebServiceExample/insurance", 
    			service);
    ...
    private void initializeSession() {
        ...
        kbuilder.add(new ClassPathResource("HospitalInvokeInsuranceScenarioV2-data.bpmn"), ResourceType.BPMN2);

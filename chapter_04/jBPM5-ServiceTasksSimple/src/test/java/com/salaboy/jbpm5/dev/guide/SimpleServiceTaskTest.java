...
import com.salaboy.jbpm5.dev.guide.workitems.AutoHumanWorkItemHandler;
import com.salaboy.jbpm5.dev.guide.workitems.NotificationSystemWorkItemHandler;

public class SimpleServiceTaskTest {
    ...
    private void initializeSession() {
        ...
        kbuilder.add(new ClassPathResource("HospitalEmergencyScenarioV1-data.bpmn"), ResourceType.BPMN2);
